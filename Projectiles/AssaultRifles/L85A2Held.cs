...
{
    public class L85A2Held : WeaponBase
    {
        public override int CurrentAmmo
        {
            get
            {
                return MagazineTracking.L85A2Magazine;
            }
            set
            {
                MagazineTracking.L85A2Magazine = value;
            }
        }

        public int G40mmDamage = 0;

        private SoundStyle Fire => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/shoot")
        {
        ...
        private SoundStyle ShootGrenade => new("InsurgencyWeapons/Sounds/Weapons/Ins2/ag36/shoot")
        {
            Pitch = Main.rand.NextFloat(-0.1f, 0.1f),
            MaxInstances = 0,
            Volume = 0.4f
        ...
        private SoundStyle Empty => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/empty");
        private SoundStyle MagIn => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/magin");
        private SoundStyle MagOut => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/magout");
        private SoundStyle BoltBack => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/bltbk");

        private SoundStyle BoltRel => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l85a2/bltrel");
        ...
        public override void SetDefaults()
        {
            ...
            GrenadeLauncherAmmoType = ModContent.ItemType<Grenade40mm>();
        ...
        {
            CurrentAmmo = MagazineTracking.L85A2Magazine;
        ...
        public override void AI()
        {
            if (Player.HasItem(GrenadeLauncherAmmoType))
                ShowAmmoCounter(CurrentAmmo, AmmoType, true, " 40mm: ", GrenadeLauncherAmmoType);
            else
            ...
            if (MouseRightPressed && Player.CountItem(GrenadeLauncherAmmoType) > 0 && AlternateFireCoolDown == 0 && !(ReloadTimer > 0))
            {
                ...
                G40mmDamage = (int)(BulletDamage * 10f);
                ...
                if (Player.whoAmI == Main.myPlayer)
                {
                    Projectile.NewProjectileDirect(
                        ...
                        velocity: aim,
                        type: ModContent.ProjectileType<Grenade40mmProj>(),
                        damage: G40mmDamage,
            ...
            switch (ReloadTimer)
            {
                ...
                case 110:
                    ...
                    CurrentAmmo = 0;
                    if (!ManualReload)
                        DropMagazine(ModContent.ProjectileType<L85A2Magazine>());
                    break;
            }
            ...
            if (HeldItem.type != ModContent.ItemType<L85A2>())
                Projectile.Kill();

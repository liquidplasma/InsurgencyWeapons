...
{
    public class L2A3Held : WeaponBase
    {
        public override int CurrentAmmo
        {
            get
            {
                return MagazineTracking.L2A3Magazine;
            }
            set
            {
                MagazineTracking.L2A3Magazine = value;
            }
        }

        private SoundStyle Fire => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l2a3/shoot")
        {
        ...
        private SoundStyle Empty => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l2a3/empty");
        private SoundStyle MagIn => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l2a3/magin");
        private SoundStyle MagOut => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l2a3/magout");
        private SoundStyle BoltLock => new("InsurgencyWeapons/Sounds/Weapons/Ins2/l2a3/bltbk");
        ...
        public override void AI()
        {
            ...
            switch (ReloadTimer)
            {
                ...
                case 80:
                    ...
                    CurrentAmmo = 0;
                    if (!ManualReload)
                        DropMagazine(ModContent.ProjectileType<L2A3Magazine>());
                    break;
            }
            ...
            if (HeldItem.type != ModContent.ItemType<L2A3>())
                Projectile.Kill();

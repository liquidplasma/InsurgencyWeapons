    ...
    internal class Coach : Shotgun
    {
        ...
        public override void HoldItem(Player player)
        {
            if (player.ownedProjectileCounts[CoachType] < 1)
            {
                ...
                Projectile gun = ExtensionMethods.BetterNewProjectile(player, player.GetSource_ItemUse_WithPotentialAmmo(Item, Item.useAmmo), player.Center, Vector2.Zero, CoachType, Item.damage, Item.knockBack, player.whoAmI);

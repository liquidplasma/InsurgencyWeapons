    ...
    internal class ChicagoTypewriter : SubMachineGun
    {
        ...
        public override void HoldItem(Player player)
        {
            if (player.ownedProjectileCounts[M1928Type] < 1)
            {
                ...
                Projectile gun = Projectile.NewProjectileDirect(player.GetSource_ItemUse_WithPotentialAmmo(Item, Item.useAmmo), player.Center, Vector2.Zero, M1928Type, Item.damage, Item.knockBack, player.whoAmI);

    ...
    internal class PPSH41 : SubMachineGun
    {
        ...
        public override void HoldItem(Player player)
        {
            if (player.ownedProjectileCounts[PPShType] < 1)
            {
                ...
                Projectile gun = ExtensionMethods.BetterNewProjectile(player, player.GetSource_ItemUse_WithPotentialAmmo(Item, Item.useAmmo), player.Center, Vector2.Zero, PPShType, Item.damage, Item.knockBack, player.whoAmI);

    ...
    internal class M40A1 : SniperRifle
    {
        ...
        public override void HoldItem(Player player)
        {
            if (player.ownedProjectileCounts[M40Type] < 1)
            {
                ...
                Projectile gun = ExtensionMethods.BetterNewProjectile(player, player.GetSource_ItemUse_WithPotentialAmmo(Item, Item.useAmmo), player.Center, Vector2.Zero, M40Type, Item.damage, Item.knockBack, player.whoAmI);

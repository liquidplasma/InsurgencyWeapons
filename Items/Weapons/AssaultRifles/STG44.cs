    ...
    internal class STG44 : AssaultRifle
    {
        ...
        public override void HoldItem(Player player)
        {
            if (player.ownedProjectileCounts[STGType] < 1)
            {
                ...
                Projectile gun = ExtensionMethods.BetterNewProjectile(player, player.GetSource_ItemUse_WithPotentialAmmo(Item, Item.useAmmo), player.Center, Vector2.Zero, STGType, Item.damage, Item.knockBack, player.whoAmI);
